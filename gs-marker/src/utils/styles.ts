...
/**
 * to CSS prop and the value from Responsive
 * @param propKey CSS prop
 * @param prop Responsive
 * @param theme AppTheme
 * @returns CSS prop and the value (ex. background-color: white;)
 */
...
/**
 * get CSS prop value defined at Theme
 * @param propKey CSS property
 * @param value CSS prop value
 * @param theme AppTheme
 * @returns CSS prop value
 */
